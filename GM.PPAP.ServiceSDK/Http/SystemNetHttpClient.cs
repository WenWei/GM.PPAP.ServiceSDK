...
using GM.PPAP.ServiceSDK.Properties;

namespace GM.PPAP.ServiceSDK.Http
{
    /// <summary>
    ...
    public class SystemNetHttpClient : HttpClient
    {
        ...
        private HttpRequestMessage BuildHttpRequest(Request request)
        {
            ...
            var libraryVersion = "gmsvcsdk-csharp/" + AssemblyInfomation.AssemblyInformationalVersion + PlatVersion;
